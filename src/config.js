...
export const csp = `
		...
		connect-src 'self';
		font-src ${settings.HREFS[1]}/static/fonts/;
		style-src ${settings.HREFS[1]}/static/styles/;
		style-src-elem ${settings.HREFS[1]}/static/styles/;
		style-src-attr 'none';
		script-src ${settings.HREFS[1]}/static/scripts/;
		script-src-elem ${settings.HREFS[1]}/static/scripts/;
		script-src-attr 'none';
		worker-src ${settings.HREFS[1]}/static/scripts/;
		form-action ${settings.HREFS[1]}/api/;
	`.replace(/\s/g, " ");